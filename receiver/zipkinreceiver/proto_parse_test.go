...
func TestConvertSpansToTraceSpans_protobuf(t *testing.T) {
	...
	span0.Attributes().PutStr("network.local.address", "192.168.0.1")
	span0.Attributes().PutInt("net.host.port", 8009)
	span0.Attributes().PutStr("net.peer.name", "memcached")
	span0.Attributes().PutStr("network.peer.address", "fe80::1453:a77c:da4d:d21b")
	...
	span1.Attributes().PutStr("network.local.address", "10.0.0.13")
	span1.Attributes().PutInt("net.host.port", 8009)
	span1.Attributes().PutStr("net.peer.name", "redis")
	span1.Attributes().PutStr("network.peer.address", "fe80::1453:a77c:da4d:d21b")
